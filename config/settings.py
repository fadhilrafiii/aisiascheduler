...
MOBILE_NET_SCHEDULER_INTERVAL_NUMBER = env("MOBILE_NET_SCHEDULER_INTERVAL_NUMBER")
MOBILE_NET_SCHEDULER_INTERVAL_UNIT = env("MOBILE_NET_SCHEDULER_INTERVAL_UNIT")
